...
async function run() {
  try {
    ...
    // menu collection API END




    // review collection API start
    // get
    ...
    // review collection API END




    // cart collection API start
    // post
...
app.listen(port, () => {
  console.log(`Nabila is sitting ${port}`)
})